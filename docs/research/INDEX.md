...
| EXP-009 | Market State v1 + Top/Bottom signals | 🔴 DEPRECATED (based on 801001 which is 申万50, not 全A) | ❌ Deprecated | 801001 identified as 申万50 (50 large caps). All analysis invalid. | — |
...
| DATA-001 | Data readiness v1 | Stock / sector / mapping / second-pass field audit | Complete (Superseded) | All 6 pre-backtest tasks done. Original doc deleted after benchmark switch. | — |
| DATA-002 | Data runtime spec v1 | Provider adapters, SQL/storage contract, second-pass SOP | Reference (Superseded) | Original doc deleted. `daily_update.py` 统一覆盖。 | — |
